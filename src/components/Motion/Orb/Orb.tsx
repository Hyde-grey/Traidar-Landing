...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.952941, 0.517647, 0.223529); // #F38439
    const vec3 baseColor2 = vec3(0.952941, 0.517647, 0.223529); // #F38439
    const vec3 baseColor3 = vec3(0.952941, 0.517647, 0.223529); // #F38439
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      if (!hasRenderedFirstFrame && renderCount > 3) {
  ...
  return (
    <>
      <div
        ref={ctnDom}
        className={`orb-container ${isLoaded ? "orb-loaded" : "orb-loading"}`}
        style={{ visibility: isLoaded ? "visible" : "hidden" }}
      />
      {!isLoaded && <div className="orb-placeholder" />}
    </>
  );
}
